...
class AmazonEbs(PackerBuilder):
    ...
    props = {
        ...
        'skip_region_validation': (validator.boolean, False),
        'skip_save_build_region': (validator.boolean, False),
        'snapshot_groups': ([str], False),
        'snapshot_users': ([str], False),
        'snapshot_tags': ([str], False),
        ...
        'tags': (dict, False),
        'temporary_key_pair_name': (str, False),
        'temporary_security_group_source_cidrs': ([str], False),
        'token': (str, False),
        'user_data': (str, False),
        'user_data_file': (str, False),
...
class AzureSharedImageGallery(PackerProperty):
    ...
    """
    props = {
        'gallery_name': (str, False),
        'subscription': (str, False),
        'resource_group': (str, False),
...
class Azure(PackerBuilder):
    ...
    props = {
        ...
        'shared_image_gallery_destination ': (AzureSharedImageGallery, False),
        'managed_image_resource_group_name': (str, False),
        'managed_image_zone_resilient': (validator.boolean, False),
...
class GoogleCompute(PackerBuilder):
    ...
    props = {
        ...
        'enable_vtpm': (validator.boolean, False),
        'enable_integrity_monitoring': (validator.boolean, False),
        'image_description': (str, False),
...
class OpenStack(PackerBuilder):
    ...
    props = {
        ...
        'application_credential_id': (str, False),
        'application_credential_name': (str, False),
        'application_credential_secret': (str, False),
        'username': (str, False),
        'user_id': (str, False),
        'password': (str, False),
        'availability_zone': (str, False),
        ...
        'force_delete': (validator.boolean, False),
...
class Qemu(PackerBuilder):
    ...
    props = {
        ...
        'boot_wait': (str, False),
        'cpus': (int, False),
        'disk_additional_size': ([str], False),
...
class Vagrant(PackerBuilder):
    ...
    props = {
        ...
        'output_vagrantfile': (str, False),
        'package_include': (str, False),
